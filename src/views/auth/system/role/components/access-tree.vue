<template>
  <a-spin :spinning="spinning">
    <a-tree style="min-height: 40px" checkable checkStrictly :selectable="false" :tree-data="treeData" :replace-fields="replaceFields" v-model:checkedKeys="checkedKeys" @check="onCheck">
    </a-tree>
  </a-spin>
</template>
